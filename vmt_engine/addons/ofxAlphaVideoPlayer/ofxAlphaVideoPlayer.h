#ifndef _OFX_ALPHA_VIDEO_PLAYER
#define _OFX_ALPHA_VIDEO_PLAYER
...
class ofxAlphaVideoPlayer : public ofBaseVideo{

	public:


		ofxAlphaVideoPlayer ();
		virtual ~ofxAlphaVideoPlayer();
